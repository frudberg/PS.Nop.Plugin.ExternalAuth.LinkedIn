...
namespace PS.Nop.Plugin.ExternalAuth.LinkedIn.Infrastructure.Cache
{
    /// <summary>
    ...
    public partial class LinkedInAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(LinkedInExternalAuthConstants.ProviderSystemName))
                return;
